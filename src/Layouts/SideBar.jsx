...
function SideBar() {
  ...
  return (
    <div className='SideBar h-screen p-8 border-r-2'>
      ...
      <div className="mainMenu">
        ...
        <div className="Items flex flex-col gap-6 text-lg text-slate-500 cursor-pointer">
          <div className="Box flex gap-6 "onClick={() => handleItemClick('Dashboard')}>
            ...
            <h1 className={`item ${activeItem === 'Dashboard' ? 'text-red-500' : ''}`} onClick={() => handleItemClick('Dashboard')}>Dashboard
            </h1>
          </div>
          <div className="Box flex gap-6" onClick={() => handleItemClick('Recruitment')}>
            ...
            <h1 className={`item flex gap-6 ${activeItem === 'Recruitment' ? 'text-red-500' : ''}`} onClick={() => handleItemClick('Recruitment')}>Recruitment
            </h1>
          </div>
          <div className="Box flex gap-6"onClick={() => handleItemClick('Schedule')}>
            <img src={activeItem === 'Schedule' ? ActiveSchedule : Schedule} alt="" />
            <h1 className={`item flex gap-6 ${activeItem === 'Schedule' ? 'text-red-500' : ''}`} >Schedule
            </h1>
          </div>
          <div className="Box flex gap-6" onClick={() => handleItemClick('Employee')}>
            <img src={activeItem === 'Employee' ? ActiveEmployee : Employee} alt="" />
            <h1 className={`item flex gap-6 ${activeItem === 'Employee' ? 'text-red-500' : ''}`} >Employee
            </h1>
          </div>
          <div className="Box flex gap-6" onClick={() => handleItemClick('Department')}>
            ...
            <h1 className={`item flex gap-6 ${activeItem === 'Department' ? 'text-red-500' : ''}`} >Department
            </h1>
          </div>
        </div>
      </div>
      <div className="other">
        ...
        <div className="Items flex flex-col gap-6 text-lg text-slate-500 cursor-pointer">
          <div className="Box flex gap-6" onClick={() => handleItemClick('Support')}>
            ...
            <h1 className={`item flex gap-6 ${activeItem === 'Support' ? 'text-red-500' : ''}`} >Support
            </h1>
          </div>
          <div className="Box flex gap-6" onClick={() => handleItemClick('Setting')}>
            <img src={activeItem === 'Setting' ? ActiveSetting : Setting} alt="" />
            <h1 className={`item flex gap-6 ${activeItem === 'Setting' ? 'text-red-500' : ''}`} >Setting
            </h1>
          </div>
        </div>
      </div>
